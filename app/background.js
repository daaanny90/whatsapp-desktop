...
electron__WEBPACK_IMPORTED_MODULE_2__["app"].on("ready", () => {
  ...
  var appIcon = new electron__WEBPACK_IMPORTED_MODULE_2__["Tray"](iconpath);
  var contextMenu = electron__WEBPACK_IMPORTED_MODULE_2__["Menu"].buildFromTemplate([{
    label: 'Show App',
    click: function () {
      mainWindow.show();
    }
    ...
    label: 'Quit',
    click: function () {
      electron__WEBPACK_IMPORTED_MODULE_2__["app"].isQuiting = true;
